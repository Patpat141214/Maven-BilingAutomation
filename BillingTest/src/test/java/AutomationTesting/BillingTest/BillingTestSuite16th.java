package AutomationTesting.BillingTest;
...
public class BillingTestSuite16th extends SettingClass {
	...
	public void _01LI02() {
		...
		String homePage = driver.findElement(By.xpath("//div[@class='content-header' and text()='Home Page']"))
				.getText();
	...
	@Test(priority = 2)
	public void _02BIL01(String billingPeriod, String Hospital) {
		...
		WebElement kebabIcon = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"/html/body/div[1]/div/div/div[2]/div[2]/div[2]/div/div/div[3]/div[3]/div[2]/div/table/thead/tr/th[3]/a[1]/span")));
		...
		WebElement textBox = wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("/html/body/div[7]/div/ul/li[6]/div/ul/li/div/form/div/input")));
		...
		String BillingPeriod = driver
				.findElement(By.xpath("//td[@data-field='BillingPeriod' and text()='" + billingPeriod + "']"))
				.getText(); // Need to Change base on billing execution
	...
	@Test(priority = 3)
	public void _02BIL02(String billingDate) {
	...
	public void _02BIL03() {
		...
		// String ExpectedBillingDate = "Dec 16, 2024";//Need to Change base on billing
		// execution
	...
	@Test(priority = 5)
	public void _02BIL04(String billingPeriod, String expectedSoaDate) {

		Reporter.log("Start of Test ID (BIL04)", true);
		String BillingPeriod = driver
				.findElement(By.xpath("//td[@data-field='BillingPeriod' and text()='" + billingPeriod + "']"))
				.getText(); // Need to Change base on billing execution
		String soaDate = driver
				.findElement(By.xpath("//td[@data-field='SoaDate' and text()='" + expectedSoaDate + "']")).getText(); // Need
																														// to
																														// Change
																														// base
																														// on
	...
	@Test(priority = 6)
	public void _03COL01(String billingPeriod, String Hospital, String statementDate) {
		...
		WebElement kebabIcon = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"/html/body/div[1]/div/div/div[2]/div[2]/div[2]/div/div/div[3]/div[3]/div[2]/div/table/thead/tr/th[7]/a[1]/span")));
		...
		driver.findElement(By.xpath("//a[@class='k-button k-button-icontext k-grid-history' and text()='History']"))
				.click();
		...
		// currentBalance =
		// driver.findElement(By.xpath("//td[@data-field='CurrentBalance']")).getText();
		allCurrentBalance = String.format("//tr[td[@data-field='StatementDate' and text()='" + statementDate
				+ "']]/td[@data-field='CurrentBalance']", statementDate);
		...
		WebElement kebabIcon1 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"/html/body/div[1]/div/div/div[2]/div[2]/div[2]/div/div/div[3]/div[3]/div[2]/div/table/thead/tr/th[7]/a[1]/span")));
		...
		WebElement textBox1 = wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("/html/body/div[7]/div/ul/li[6]/div/ul/li/div/form/div/input")));
		...
		List<WebElement> unlockButtons = driver.findElements(
				By.xpath("//a[contains(@class, 'k-button k-button-icontext k-grid-details') and text()='Unlock']"));
		...
		driver.switchTo().frame(driver.findElement(By.tagName("iframe")));
		WebElement BillingPeriod = wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//div[text()='Billing Period:']/following-sibling::div")));
		WebElement totalClaims = wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//div[text()='Total Claims:']/following-sibling::div")));
		String totalAmount = driver.findElement(By.xpath("//div[text()='Total Amount:']/following-sibling::div"))
				.getText();

		String totalAmountFormatted = totalAmount.replace("PHP", "").trim();

		if (BillingPeriod.getText().contentEquals(billingPeriod)
				&& totalClaims.getText().contentEquals(this.totalClaims.replace(".00", ""))
				&& totalAmountFormatted.contentEquals(this.formattedTotalAmount.replace("Php", "").trim())) {
	...
	@Test(priority = 7)
	public void _03COL02(String billingPeriod) {
		...
		driver.findElement(By.xpath(
				"//button[contains(@class, 'k-button') and contains(@class, 'k-primary') and contains(@onclick, 'addPaymentWindow')]"))
				.click();
		try {
			Thread.sleep(3000); // Pause for 3 seconds to wait for the page to load
		} catch (InterruptedException e) {
		...
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		WebElement firstOption = wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//span[@class='k-input' and text()='Select Billing']")));
		firstOption.click();

		WebElement billingPeriodOption = wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("//li[@class='k-item' and text()='" + billingPeriod + "']")));
		billingPeriodOption.click();

		String BillingPeriod = driver
				.findElement(By.xpath("//span[@class='k-input'and text()='" + billingPeriod + "']")).getText();
	...
	@Test(priority = 9)
	public void _04AR01(String statementDate, String Hospital) {
		...
		WebElement navReports = driver
				.findElement(By.xpath("//span[@class='flex-grow commandbar-item-text' and text()='Reports']"));

		Actions actions = new Actions(driver);
		actions.moveToElement(navReports).perform();

		WebElement AccReceivable = driver
				.findElement(By.xpath("//span[@class='context-menu-itemText' and text()='Accounts Receivable']"));
		AccReceivable.click();
	...
	@Parameters({ "billingPeriod" })
	@Test(priority = 10)
	public void _04AR02(String billingPeriod) {
	...
	@Parameters({ "billingPeriod", "Hospital" })
	@Test(priority = 11)
	public void _05SOA01(String billingPeriod, String Hospital) {
		...
		WebElement navReportsSOA = driver.findElement(
				By.xpath("//span[@class='flex-grow commandbar-item-text' and text()='Statement Of Account']"));
		navReportsSOA.click();
		...
		WebElement kebabIcon = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"/html/body/div[1]/div/div/div[2]/div[2]/div[2]/div/div/div[3]/div[3]/div[2]/div/table/thead/tr/th[1]/a[1]/span")));
		...
		String getBillingPeriod = driver
				.findElement(By.xpath("//td[@data-field='BillingPeriod' and text()='" + billingPeriod + "']"))
				.getText();
	...
	@Parameters({ "billingDate" })
	@Test(priority = 12)
	public void _05SOA02(String billingDate) {
	...
	@Parameters({ "billingPeriod" })
	@Test(priority = 14)
	public void _05SOA04(String billingPeriod) {
		...
		WebElement navSoaReport = driver.findElement(By.xpath("//td[@data-field='BillingPeriod' and text()='"
				+ billingPeriod
				+ "']//following-sibling::td//a[@class='k-button k-button-icontext k-grid-report' and text()='SOA']"));
	...
	@Parameters({ "billingPeriod" })
	@Test(priority = 15)
	public void _05SOA5(String billingPeriod) {
		Reporter.log("Start of Test ID (SOA05)", true);

		String navSoaReportBillingPeriod = driver
				.findElement(By.xpath("//div[contains(text(), '" + billingPeriod + "')]")).getText();
	...
	@Test(priority = 16)
	public void _05SOA06() {
		Reporter.log("Start of Test ID (SOA06)", true);

		String getTotalClaims = driver
				.findElement(
						By.xpath("//div[text()='" + this.totalClaims.replace(".00", "").trim().replace(",", "") + "']"))
				.getText();
		...
		String getTotalClaimsSubFreeTrial = driver
				.findElement(By.xpath("//div[(text()='" + totalClaimsWithFreeFormatted + "')]")).getText();
	...
	@Test(priority = 17)
	public void _05SOA07() {
		Reporter.log("Start of Test ID (SOA07)", true);

		String getTotalAmount = driver
				.findElement(By.xpath("//div[text()='" + this.formattedTotalAmount.replace("Php", "₱").trim() + "']"))
				.getText();
	...
	public void _05SOA10() {
		...
		String TotalAmount = driver.findElement(By.xpath("//div[text()='" + formattedresultVatSalesAddVat + "']"))
				.getText();
	...
	@Test(priority = 21)
	public void _05SOA11() {
		Reporter.log("Start of Test ID (SOA11)", true);

		String CurrentBalance = driver
				.findElement(By.xpath("//div[text()='(" + this.formattedAllCurrentBalance + ")']")).getText();

		if (CurrentBalance.contentEquals("(" + this.formattedAllCurrentBalance + ")")
				|| CurrentBalance.contentEquals(("(₱ 0.00)"))) {
	...
	@Test(priority = 22)
	public void _05SOA12() {
		Reporter.log("Start of Test ID (SOA12)", true);

		String amountDue = driver
				.findElement(By.xpath("//div[text()='" + this.amountDue.replace("Php", "₱").trim() + "']")).getText();
	...
	public void _05SOA13() {
		...
		if (TotalPayment.contentEquals("(" + this.formattedAllCurrentBalance + ")")) {
			...
			Reporter.log("Total Payment covered in generated billing: " + ("(" + this.formattedAllCurrentBalance + ")"),
					true);
	...
	@Test(priority = 24)
	public void _05SOA14() {
		Reporter.log("Start of Test ID (SOA14)", true);

		// double formatAmountDue = Double.parseDouble(this.amountDue.replace("Php",
		// "").trim());
		// double formatFormattedTotalAmount =
		// Double.parseDouble(this.formattedTotalAmount)

		double formatFormattedAllCurrentBalance = Double
				.parseDouble(this.formattedAllCurrentBalance.replace("₱", "").trim().replace(",", ""));
		double formatAmountDue = Double.parseDouble(this.amountDue.replace("Php", "").trim().replace(",", ""));
		double formatFormattedTotalAmount = Double
				.parseDouble(this.formattedTotalAmount.replace("Php", "").trim().replace(",", ""));
	...
	@Test(priority = 25)
	public void _05SOA15(String link2, String Hospital, String billingPeriod, String billingDate) {
		...
		WebElement navClaimReport = driver.findElement(By.xpath("//td[@data-field='BillingPeriod' and text()='"
				+ billingPeriod
				+ "']//following-sibling::td//a[@class='k-button k-button-icontext k-grid-view' and text()='Claims']"));
		...
		String TotalClaims = driver
				.findElement(By.xpath("//h4[@class='content-header total-claims' and contains(text(),'"
						+ this.totalClaims.replace(".00", "").trim().replace(",", "") + "')]"))
				.getText();
		...
		String rowCount = String.format("//tr[td[@data-field='StatementDate' and text()='" + billingDate
				+ "'] and td[@data-field='BillingPeriod' and text()='" + billingPeriod + "']]");
