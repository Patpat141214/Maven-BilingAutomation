...
public class BillingTestSuite30th31st extends SettingClass {
	...
	public void _02CL01(String Hospital) {
		...
		WebElement navAccounts = driver
				.findElement(By.xpath("//span[@class='flex-grow commandbar-item-text' and text()='Accounts']"));
		...
		WebElement kebabIcon = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"/html/body/div[1]/div/div/div[2]/div[2]/div[2]/div/div/div[3]/div[3]/div[2]/div/table/thead/tr/th[2]/a[1]/span")));
	...
	public void _03BIL01(String billingPeriod, String Hospital, String billingPeriodForMonthly,
		...
		billingValue = driver.findElement(By.xpath("//tr[td[@data-field='BillingPeriod' and text()='"
				+ billingPeriodForMonthly + "']]/td[@data-field='TotalAmount']")).getText();

		double bilValue = Double.parseDouble(billingValue.replace("Php", "").trim().replace(",", ""));

		billingValue1 = driver.findElement(By.xpath("//tr[td[@data-field='BillingPeriod' and text()='"
				+ billingPeriodForMonthly1 + "']]/td[@data-field='TotalAmount']")).getText();
...
// Print the result
	...
	public void _06BS01(String billingStatement, String Hospital) {
		...
		WebElement billStatemeent = driver.findElement(
				By.xpath("//span[@class='flex-grow commandbar-item-text' and text()='Billing Statement']"));
		...
		String BillingStatement = driver
				.findElement(By.xpath("//td[@data-field='Issued' and text()='" + billingStatement + "']")).getText();

		WebElement viewBillingStatement = driver
				.findElement(By.xpath("//a[@class='k-button k-button-icontext k-grid-view' and text()='View']"));
	...
	public void _06BS02() {
		...
		String billingValue = driver.findElement(By.xpath("//div[text()='" + this.formattedTotalBilValue + "']"))
				.getText();
